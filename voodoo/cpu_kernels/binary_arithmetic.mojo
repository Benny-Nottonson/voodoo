...
alias Mul = Generic[mul_fw, bw_mul_a, bw_mul_b]
alias Sub = Generic[sub_fw, bw_sub, bw_sub]
alias Div = Generic[div_fw, bw_div_a, bw_div_b]
alias Pow = Generic[pow_fw, bw_pow_a, bw_pow_b]
alias MMul = _MMul
