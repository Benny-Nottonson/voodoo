...
struct Kernels:
    ...
    fn __init__() -> Kernels:
        ...
        k.store("elu", elu_code, Elu.fw, Elu.bw)
        k.store("exp", exp_code, Exp.fw, Exp.bw)
        k.store("gelu", gelu_code, Gelu.fw, Gelu.bw)
        ...
        k.store("relu", relu_code, ReLu.fw, ReLu.bw)
        k.store("selu", selu_code, Selu.fw, Selu.bw)
        k.store("sig", sig_code, Sigmoid.fw, Sigmoid.bw)
        ...
        k.store("swish", swish_code, Swish.fw, Swish.bw)
        k.store("tanh", tanh_code, Tanh.fw, Tanh.bw)
        k.store("lrelu", lrelu_code, LeakyReLu.fw, LeakyReLu.bw)
