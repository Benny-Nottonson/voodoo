...
struct Tensor[
    ...
    @always_inline("nodebug")
    fn copy(self) raises -> Tensor[shape, False, False]:
    ...
    ](self) raises -> Tensor[shape, False, False]:
        var new_tensor = self.load_tensor_for_unary_op()
    ...
    fn _magic_arithmetic_generic[
        operation_code: Int
    ](self, other: Tensor) raises -> Tensor[shape, False, False]:
    ...
    @always_inline("nodebug")
    fn __add__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self._magic_arithmetic_generic[add_code](other)

    @always_inline("nodebug")
    fn __sub__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self._magic_arithmetic_generic[sub_code](other)

    @always_inline("nodebug")
    fn __mul__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self._magic_arithmetic_generic[mul_code](other)

    @always_inline("nodebug")
    fn __truediv__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self._magic_arithmetic_generic[div_code](other)

    @always_inline("nodebug")
    fn __pow__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self._magic_arithmetic_generic[pow_code](other)

    @always_inline("nodebug")
    fn __matmul__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        var new_tensor = self.load_tensor_for_binary_op(other)
        new_tensor.node = new_tensor.graph.mmul(self.node, other.node)
        return new_tensor

    @always_inline("nodebug")
    fn __radd__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self.__add__(other)

    @always_inline("nodebug")
    fn __rsub__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self.__sub__(other)

    @always_inline("nodebug")
    fn __rmul__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self.__mul__(other)

    @always_inline("nodebug")
    fn __rtruediv__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self.__truediv__(other)

    @always_inline("nodebug")
    fn __rpow__(self, other: Tensor) raises -> Tensor[shape, False, False]:
        return self.__pow__(other)

    @always_inline("nodebug")
    fn __rmatmul__(self, other: Tensor) raises -> Tensor[shape, False, False]:
    ...
    @always_inline("nodebug")
    fn _prep_scalar_tensor(self, number: Float32) raises -> Tensor[shape, False, True]:
        let new_tensor = Tensor[shape, False, True]().fill(number)
        new_tensor.node.set_computed(True)
        return new_tensor

    @always_inline("nodebug")
    fn __add__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__add__(self._prep_scalar_tensor(number))

    @always_inline("nodebug")
    fn __sub__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__sub__(self._prep_scalar_tensor(number))

    @always_inline("nodebug")
    fn __mul__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__mul__(self._prep_scalar_tensor(number))

    @always_inline("nodebug")
    fn __truediv__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__truediv__(self._prep_scalar_tensor(number))

    @always_inline("nodebug")
    fn __pow__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__pow__(self._prep_scalar_tensor(number))

    @always_inline("nodebug")
    fn __radd__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__add__(number)

    @always_inline("nodebug")
    fn __rsub__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__sub__(number)

    @always_inline("nodebug")
    fn __rmul__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__mul__(number)

    @always_inline("nodebug")
    fn __rtruediv__(self, number: Float32) raises -> Tensor[shape, False, False]:
        return self.__truediv__(number)

    @always_inline("nodebug")
    fn __rpow__(self, number: Float32) raises -> Tensor[shape, False, False]:
        var other = Tensor[shape, False, False]().fill(number)
    ...
    @always_inline("nodebug")
    fn flatten(self) raises -> Tensor[shape, False, False]:
        var new_tensor = self.load_tensor_for_unary_op()
    ...
    @always_inline("nodebug")
    fn transp(self) raises -> Tensor[shape, False, False]:
        var new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node = new_tensor.graph.transp(self.node)
        return new_tensor

    @always_inline("nodebug")
    fn sum(self) raises -> Tensor[shape, False, False]:
        var new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node = new_tensor.graph.sum(self.node)
        return new_tensor

    @always_inline("nodebug")
    fn compute_function[operator_id: Int](self) raises -> Tensor[shape, False, False]:
        var new_tensor = self.load_tensor_for_unary_op()
    ...
    ) raises -> Tensor[shape, False, False]:
        var new_tensor = self.load_tensor_for_binary_op(other)
